...
// 当客户端连接时
$quicServer->onConnect = function (TcpConnection $connection): void {
    echo "New QUIC connection\n";
};

// 当收到客户端数据时
$quicServer->onMessage = function (TcpConnection $connection, $data): void {
